export default function NavbarSearch({
  ...
  return (
    <>
      <div className="flex md:order-1 order-2">
        ...
        <div className="relative hidden md:block z-10">
          ...
          <input
            type="text"
            id="search-navbar"
            className="block w-full p-2 pl-10 text-sm border  rounded-lg  focus:ring-blue-500 focus:border-blue-500 bg-gray-700 border-gray-600placeholder-gray-400 text-white"
            placeholder="Search..."
          />
        </div>
      </div>
      {open ? (
        <div
          className="items-center justify-between hidden w-full  md:w-auto md:order-1 z-10"
          id="navbar-search"
        >
